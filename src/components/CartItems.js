      ...
      <div className="columns is-variable is-3 is-mobile">
        ...
        <div className="column">
          ...
          <select
              ...
              onChange={(event) => {setItemQuantity(sku, parseInt(event.target.value))}}
          >
          {options}
        </select>
          </div>
    ...
    <div className="column is-narrow">
      <figure className="image">
        <svg width="32" height="48" viewBox="0 0 32 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M16 43C24.2843 43 31 36.2843 31 28C31 19.7157 24.2843 13 16 13C7.71573 13 1 19.7157 1 28C1 36.2843 7.71573 43 16 43Z" stroke="#8B384B" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="square"/>
          <path d="M10 34H22" stroke="#8B384B" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="square"/>
